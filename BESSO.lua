...
local BESSO = false  
if tonumber(msg.sender_user_id_) == tonumber(1099083018) then
BESSO = true  
end
return BESSO  
end 
...
elseif database:sismember(bot_id..'Basic:Constructor'..chat_id, user_id) then
var = database:get(bot_id.."BasicConstructor:Rd"..msg.chat_id_) or 'مالك اساسي 🧑🏻‍🚀'
elseif database:sismember(bot_id..'Constructor'..chat_id, user_id) then
var = database:get(bot_id.."Constructor:Rd"..msg.chat_id_) or 'مالك 👨🏻‍💼'  
elseif database:sismember(bot_id..'Manager'..chat_id, user_id) then
var = database:get(bot_id.."Manager:Rd"..msg.chat_id_) or 'نائب مدير 👮🏻‍♂️'  
elseif database:sismember(bot_id..'Mod:User'..chat_id, user_id) then
...
send(chat,msg.id_,"\n-› تم رفع الملف بنجاح وتفعيل المجموعات\n-› ورفع {الامالكين الاساسين ; والمالكين ; والنائبين; والادمنيه} بنجاح")   
end
...
SourceBESSOr = '-›  مرحبا عزيزي ...'..'\n-›  انا بوت حماية كروبات '..'\n-›  اضفني الى مجموعتك وقم بترقيتي ادمن ويستطيع »{ مالك او المشرفين } بتفعيل فقط '
end 
...
os.execute('wget https://raw.githubusercontent.com/SorceLink/BESSO/master/BESSO.lua')
...
usertext = '\n-› العضو » ['..result.title_..'](t.me/'..(username or 'SourceDilar ')..')'
...
send(msg.chat_id_,0,"-› العضو : {["..data.first_name_.."](T.ME/SourceDilar )}\n-› ["..BESSO_Msg.."] \n") 
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, "⚠┇عذرا يا » {["..data.first_name_.."](T.ME/SourceDilar )}\n📛┇ الملصق الذي ارسلته تم منعه من المجموعه \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
send(msg.chat_id_, msg.id_,'-›  فعلت المجموعة من ')
else
...
send(msg.chat_id_, msg.id_, t..'————× Dilar 𝒔𝒐𝒓𝒖𝒄𝒆 ×————')
end
...
send(msg.chat_id_, msg.id_,'-›  ارسل لي الامر القديم')  
return false
end
...
send(msg.chat_id_, msg.id_,'-›  ابشر حذفت الامر')  
else
...
send(msg.chat_id_, msg.id_,'-›  ارسل لي الامر الجديد')  
...
send(msg.chat_id_, msg.id_,'-›  ابشر حفظت الامر')  
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'-› مين ← ['..utf8.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'SourceDilar ')..') \n-› ابشر قفلت الملفات ')  
end,nil)   
elseif text == 'قفل الملفات بالتقييد' and Mod(msg) and msg.reply_to_message_id_ == 0 then 
database:set(bot_id.."lock:Document"..msg.chat_id_,'ked')  
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'-› مين ← ['..utf8.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'SourceDilar ')..') \n-› ابشر قفلت الملفات بالتقييد ')  
end,nil)   
elseif text == 'قفل الملفات بالكتم' and Mod(msg) and msg.reply_to_message_id_ == 0 then 
database:set(bot_id.."lock:Document"..msg.chat_id_,'ktm')  
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'-› مين ← ['..utf8.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'SourceDilar ')..') \n-› ابشر قفلت الملفات بالكتم ')  
end,nil)   
elseif text == 'قفل الملفات بالطرد' and Mod(msg) and msg.reply_to_message_id_ == 0 then 
database:set(bot_id.."lock:Document"..msg.chat_id_,'kick')  
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'-› بواسطه ← ['..utf8.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'SourceDilar ')..') \n-› ابشر قفلت الملفات بالطرد ')  
end,nil)   
...
send(msg.chat_id_, msg.id_,'-› ابشر قفلت التكرار بالحذف')
...
send(msg.chat_id_, msg.id_,'-› ابشر فتحت التكرار')
end 
--------------------------------------------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_, "-›  لا يمكنني حظر مطوري الاساسي \n")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
send(msg.chat_id_, msg.id_, "-›  لا استطيع حظر نفسي عام")
return false 
end
...
usertext = '\n» ['..result.title_..'](t.me/'..(username or 'SourceDilar ')..')'
status  = '\n-›   حظرته عام من المجموعات'
texts = usertext..status
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\nالحلو » ['..data.first_name_..'](t.me/'..(data.username_ or 'SourceDilar ')..')'
status  = '\n-›  رفعته صار مطور في البوت'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
database:sadd(bot_id..'Sudo:User', result.id_)
usertext = '\nالحلو » ['..result.title_..'](t.me/'..(username or 'SourceDilar ')..')'
status  = '\n-›  رفعته صار مطور في البوت'
texts = usertext..status
else
texts = '-›  لا يوجد حساب بهاذا المعرف'
...
send(msg.chat_id_, msg.id_, '\n🗑¦ ابشر عيني مسحت قائمه المالكين الاساسين')
return false
end
...
if text ==("رفع المالك") and Sudo(msg) then 
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data) 
local admins = data.members_
for i=0 , #admins do
if data.members_[i].status_.ID == "ChatMemberStatusCreator" then
...
send(msg.chat_id_, msg.id_,"-›رفعته صار مالك المجموعه  ["..b.first_name_.."](T.me/"..UserName..")")  
database:sadd(bot_id.."Basic:Constructor"..msg.chat_id_,b.id_)
end,nil)   
end,nil)   
end

if text == ("رفع مالك اساسي") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع مالك اساسي @(.*)$") and Sudo(msg) then
...
if text and text:match("^رفع مالك اساسي (%d+)$") and Sudo(msg) then
local userid = text:match("^رفع مالك اساسي (%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == ("تنزيل مالك اساسي") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل مالك اساسي @(.*)$") and Sudo(msg) then
...
if text and text:match("^تنزيل مالك اساسي (%d+)$") and Sudo(msg) then
local userid = text:match("^تنزيل مالك اساسي (%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
------------------------------------------------------------------------
if text == 'مسح المالكين' and BasicConstructor(msg) then
database:del(bot_id..'Constructor'..msg.chat_id_)
texts = '🗑¦  ابشر عيني مسحت المالكين '
send(msg.chat_id_, msg.id_, texts)
end

if text == ("المالكين") and BasicConstructor(msg) then
...
if text == "رفع مالك" and msg.reply_to_message_id_ and BasicConstructor(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
------------------------------------------------------------------------
if text and text:match("^رفع مالك (%d+)$") and BasicConstructor(msg) then
...
if text and text:match("^تنزيل مالك$") and msg.reply_to_message_id_ and BasicConstructor(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
------------------------------------------------------------------------
if text and text:match("^تنزيل مالك (%d+)$") and BasicConstructor(msg) then
...
------------------------------------------------------------------------
if text == 'مسح النائبين' and Constructor(msg) then
database:del(bot_id..'Manager'..msg.chat_id_)
texts = '🗑¦  ابشر عيني مسحت النائبين '
send(msg.chat_id_, msg.id_, texts)
end
if text == ("النائبين") and Constructor(msg) then
...
if text == ("رفع نائب مدير") and msg.reply_to_message_id_ and Constructor(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع نائب مدير @(.*)$") and Constructor(msg) then
...
if text and text:match("^رفع نائب مدير (%d+)$") and Constructor(msg) then
local userid = text:match("^رفع نائب مدير (%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == ("تنزيل نائب مدير") and msg.reply_to_message_id_ and Constructor(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل نائب مدير @(.*)$") and Constructor(msg) then
...
if text and text:match("^تنزيل نائب مدير (%d+)$") and Constructor(msg) then
local userid = text:match("^تنزيل نائب مدير (%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if num2 == 0 then
send(msg.chat_id_, msg.id_,"-›   مافيه ادمنيه عشان ارفعهم") 
else
...
send(msg.chat_id_, msg.id_, '🗑¦ ابشر عيني مسحت  قائمة الادمنية  ')
end
...
send(msg.chat_id_, msg.id_,'-› تم تعطيل الرفع من قبل الادارة') 
return false
end
database:sadd(bot_id..'Mod:User'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n-› الحلو » ['..data.first_name_..'](t.me/'..(data.username_ or 'DEVBESSO')..')'
status  = '\n-› رفعته صار ادمن'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
...
if database:get(bot_id..'Lock:Add:Bot'..msg.chat_id_) and not Constructor(msg) then
send(msg.chat_id_, msg.id_,'-› تم تعطيل الرفع من قبل المالكين') 
return false
end
function start_function(extra, result, success)
if result.id_ then
...
usertext = '\n-› الحلو » ['..result.title_..'](t.me/'..(username or 'DEVBESSO')..')'
status  = '\n-› رفعته صار ادمن'
texts = usertext..status
else
texts = '-› لا يوجد حساب بهاذا المعرف'
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n » ['..data.first_name_..'](t.me/'..(data.username_ or 'DEVBESSO')..')'
status  = '\n-› نزلته من الادمن'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
...
usertext = '\n» ['..result.title_..'](t.me/'..(username or 'DEVBESSO')..')'
status  = '\n-› نزلته من الادمن'
texts = usertext..status
else
texts = '-›  لا يوجد حساب بهاذا المعرف'
...
if database:get(bot_id..'Lock:kick'..msg.chat_id_) and not Constructor(msg) then
send(msg.chat_id_, msg.id_,'-›  تم تعطيل الطرد من قبل الادارة') 
return false
end
function start_function(extra, result, success)
if result.id_ then
if tonumber(result.id_) == tonumber(bot_id) then  
send(msg.chat_id_, msg.id_, "-› هذا انا لا يمكنني طرد نفسي ")
return false 
end
if Can_or_NotCan(result.id_, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, '\n-›  عذرا لا يمكنني طرده ( '..Rutba(result.id_,msg.chat_id_)..' )')
else
tdcli_function ({ ID = "ChangeChatMemberStatus", chat_id_ = msg.chat_id_, user_id_ = result.id_, status_ = { ID = "ChatMemberStatusKicked" },},function(arg,data) 
if (result and result.type_ and result.type_.ID == "ChannelChatInfo") then
send(msg.chat_id_,msg.id_,"-›  عذرا عزيزي المستخدم هاذا معرف قناة يرجى استخدام الامر بصوره صحيحه !")   
...
send(msg.chat_id_, msg.id_, '-›  ابشر عيني مسحت  قائمة الاعضاء المميزين  ')
end
...
send(msg.chat_id_, msg.id_, '-›  ابشر مسحت  قائمة الاعضاء المطايه  ')
end
...
send(msg.chat_id_, msg.id_, '🗑¦  ابشر مسحت  قائمة الاعضاء الصخوله  ')
end
...
send(msg.chat_id_, msg.id_, '🗑¦  ابشر مسحت  قائمة الاعضاء القروده  ')
end
...
send(msg.chat_id_, msg.id_, '🗑¦  ابشر مسحت  قائمة الاعضاء الحصونه  ')
end
...
send(msg.chat_id_, msg.id_, '🗑¦  ابشر مسحت  قائمة الاعضاء البقرات  ')
end
...
send(msg.chat_id_, msg.id_, '🗑¦  ابشر مسحت  قائمة الاعضاء الطليان  ')
end
...
send(msg.chat_id_, msg.id_, '🗑¦  ابشر مسحت  قائمة الاعضاء الزواحف  ')
end
...
send(msg.chat_id_, msg.id_, '🗑¦  ابشر مسحت  قائمة الاعضاء الجريذيه  ')
end
...
send(msg.chat_id_, msg.id_, '\n-›  عذرا لا استطيع كتم ( '..Rutba(Besso.sender_user_id_,msg.chat_id_)..' )')
else
...
if database:get(bot_id..'Lock:kick'..msg.chat_id_) and not Constructor(msg) then
send(msg.chat_id_, msg.id_,'-› تم تعطيل الحظر من قبل الادارة') 
return false
end
function start_function(extra, result, success)
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
send(msg.chat_id_, msg.id_, "-›  لا استطيع حظر نفسي ")
return false 
end
if Can_or_NotCan(result.sender_user_id_, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, '\n-›  عذرا لا استطيع طرد او حظر او كتم او تقييد ( '..Rutba(result.sender_user_id_,msg.chat_id_)..' )')
else
...
if Can_or_NotCan(userid, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, '\n-›  عذرا لا استطيع طرد او حظر او كتم او تقييد ( '..Rutba(userid,msg.chat_id_)..' )')
else
tdcli_function ({ ID = "ChangeChatMemberStatus", chat_id_ = msg.chat_id_, user_id_ = userid, status_ = { ID = "ChatMemberStatusKicked" },},function(arg,data) 
if (data and data.code_ and data.code_ == 400 and data.message_ == "CHAT_ADMIN_REQUIRED") then 
send(msg.chat_id_, msg.id_,'-›  ليس لدي صلاحية حظر المستخدمين يرجى تفعيلها !') 
...
function start_function(extra, result, success)
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
send(msg.chat_id_, msg.id_, "-›  لااستطيع كتم البوت ")
return false 
end
if Can_or_NotCan(result.sender_user_id_, msg.chat_id_) == true then
...
if result.id_ then
if tonumber(result.id_) == tonumber(bot_id) then  
send(msg.chat_id_, msg.id_, "-›  لااستطيع كتم نفسي ")
return false 
end
if Can_or_NotCan(result.id_, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, '\n-›  عذرا لااستطيع  كتم ( '..Rutba(result.id_,msg.chat_id_)..' )')
else
if (result and result.type_ and result.type_.ID == "ChannelChatInfo") then
send(msg.chat_id_,msg.id_,"-›  عذرا عزيزي المستخدم هاذا معرف قناة يرجى استخدام الامر بصوره صحيحه !")   
return false 
...
if Can_or_NotCan(userid, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, '\n-›  عذرا لااستطيع  كتم ( '..Rutba(userid,msg.chat_id_)..' )')
else
if msg.can_be_deleted_ == false then 
send(msg.chat_id_, msg.id_,'-›  البوت ليس ادمن يرجى ترقيتي !') 
return false  
...
function start_function(extra, result, success)
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
send(msg.chat_id_, msg.id_, "-›  لااستطيع تقيد نفسي ")
return false 
end
...
send(msg.chat_id_, msg.id_, '\n-›  عذرا لا استطيع طرد او حظر او كتم او تقييد ( '..Rutba(result.id_,msg.chat_id_)..' )')
return false 
end      
https.request("https://api.telegram.org/bot"..token.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id="..result.id_)
 
usertext = '\n» ['..result.title_..'](t.me/'..(username or 'SourceDilar')..')'
status  = '\n-›  ابشر قييده من مجموعتك'
texts = usertext..status
else
texts = '-›  لا يوجد حساب بهاذا المعرف'
end
...
send(msg.chat_id_, msg.id_, '\n-›  عذرا لااستطيع طرد او حظر او كتم او تقييد ( '..Rutba(userid,msg.chat_id_)..' )')
else
...
if text and text:match("^تغير رد المالك الاساسي (.*)$") and Manager(msg) then
local Teext = text:match("^تغير رد المالك الاساسي (.*)$") 
database:set(bot_id.."BasicConstructor:Rd"..msg.chat_id_,Teext)
send(msg.chat_id_, msg.id_,"👥┋ ابشر غيرت رد المالك الاساسي الى » "..Teext)
end
...
if text and text:match("^تغير رد النائب مدير (.*)$") and Manager(msg) then
local Teext = text:match("^تغير رد النائب مدير (.*)$") 
database:set(bot_id.."Manager:Rd"..msg.chat_id_,Teext) 
send(msg.chat_id_, msg.id_,"👥┋ ابشر غيرت رد النائب مدير الى » "..Teext)
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n» ['..data.first_name_..'](t.me/'..(data.username_ or 'SourceDilar ')..')'
status  = '\n-›  ابشر رفعت ادمن بالكروب بكل الصلاحيات'
send(msg.chat_id_, msg.id_, usertext..status)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n» ['..data.first_name_..'](t.me/'..(data.username_ or 'SourceDilar ')..')'
status  = '\n-›  ابشر نزلت ادمن من الكروب بكل الصلاحيات'
send(msg.chat_id_, msg.id_, usertext..status)
https.request("https://api.telegram.org/bot"..token.."/promoteChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" ..result.sender_user_id_.."&can_change_info=false&can_delete_messages=false&can_invite_users=false&can_restrict_members=false&can_pin_messages=false&can_promote_members=false")
end,nil)
end
...
send(msg.chat_id_,msg.id_,"-›  التثبيت والغاء التثبيت تم قفله من قبل الادارة")  
return false  
end
tdcli_function ({ID = "PinChannelMessage",channel_id_ = msg.chat_id_:gsub('-100',''),message_id_ = msg.reply_to_message_id_,disable_notification_ = 1},function(arg,data) 
if data.ID == "Ok" then
send(msg.chat_id_, msg.id_,"-›  ابشر تم  تثبيت الرساله")   
...
if data.ID == "Ok" then
send(msg.chat_id_, msg.id_,"-›  ابشر تم  الغاء تثبيت الرساله")   
...
send(msg.chat_id_,msg.id_,"-›  تمام عيني الحين ارسل رابط  مجموعتك")
...
send(msg.chat_id_, msg.id_,"-›ابشر فعلت الرابط") 
return false  
end
end
...
send(msg.chat_id_, msg.id_,"-›الامر معطل من الادارة") 
return false  
end
...
send(msg.chat_id_,msg.id_,"-› ابشر مسحت الرابط ")           
...
send(msg.chat_id_, msg.id_,'-›  ابشر مسحت الصوره') 
end
return false  
end
...
send(msg.chat_id_, msg.id_,'-›  ابشر فعلت الترحيب') 
return false  
end
...
send(msg.chat_id_, msg.id_,'-›  ابشر عطلت الترحيب') 
return false  
end
if text == 'مسح الترحيب' or text == 'حذف الترحيب' then 
if Mod(msg) then
database:del(bot_id..'Get:Welcome:Group'..msg.chat_id_) 
send(msg.chat_id_, msg.id_,'-›  ابشر حذفت الترحيب') 
end
return false  
end
...
t = "\n-›  قائمة المنع \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(list) do  
local SourceDilar_Msg = database:get(bot_id.."Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..''..k..'- '..v..' » {'..SourceDilar_Msg..'}\n'    
end  
if #list == 0 then  
...
if text == 'نائب مدير' or text == 'ادمن' or text == 'مميز' or text == 'عضو' then
...
database:set(bot_id.."Comd:New:rt:user:"..msg.chat_id_..result.sender_user_id_,RTPA)
database:sadd(bot_id..'Mod:User'..msg.chat_id_,result.sender_user_id_)  
elseif blakrt == 'نائب مدير' and Constructor(msg) then
send(msg.chat_id_, msg.id_,'\n-›  العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'ZNZNN')..')'..'\n☑️┇ تم رفعه '..RTPA..' هنا\n')   
database:set(bot_id.."Comd:New:rt:user:"..msg.chat_id_..result.sender_user_id_,RTPA)  
database:sadd(bot_id..'Manager'..msg.chat_id_,result.sender_user_id_)  
...
if text == ("مسح ردود النائب مدير") and Manager(msg) then
...
send(msg.chat_id_, msg.id_,"-›   تم مسح ردود النائب مدير")
end

if text == ("ردود النائب مدير") and Manager(msg) then
local list = database:smembers(bot_id..'List:Manager'..msg.chat_id_..'')
text = "-›  قائمه ردود النائب مدير \n━━━━━━━━━━━━━\n"
for k,v in pairs(list) do
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'ديلار').." غادر" or text == 'غادر' then  
...
if text == 'تفعيل ردود النائب مدير' and Manager(msg) then   
if database:get(bot_id..'Reply:Manager'..msg.chat_id_) then
Text = '-› تم تفعيل ردود النائب مدير'
...
if text == 'تعطيل ردود النائب مدير' and Manager(msg) then  
if not database:get(bot_id..'Reply:Manager'..msg.chat_id_) then
database:set(bot_id..'Reply:Manager'..msg.chat_id_,true)  
Text = '\n-› تم تعطيل ردود النائب مدير' 
else
Text = '\n-› بالتاكيد تم تعطيل ردود النائب مدير'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
send(msg.chat_id_, msg.id_,'-›  امر اطردني تم تعطيله من قبل النائبين ') 
end
end
...
send(msg.chat_id_, msg.id_,'-›  امر صيح تم تعطيله من قبل النائبين ') 
end
return false
end
...
send(msg.chat_id_, msg.id_,'-› امر منو ضافني تم تعطيله من قبل النائبين ') 
end
end
...
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
local texting = {"نجب انت  😤","بيك مرض الا تتحارش ترا اصيح النائب مدير😒","اهو  هم اجه الملطلط ويغلط","بحلكك يحلو😾👻-• صار حمبي 🐸💉ֆ" }
send(msg.chat_id_, msg.id_, ''..texting[math.random(#texting)]..'')
end
end
...
-› م6 ← اوامر المطورين
————× Dilar 𝒔𝒐𝒓𝒖𝒄𝒆 ×————
-›  CH ← [Dilar 𝒔𝒐𝒓𝒖𝒄𝒆](t.me/SourceDilar)
]]
send(msg.chat_id_, msg.id_,Text) 
return false
end
...
if text == 'م3' then
if not Mod(msg) then
send(msg.chat_id_, msg.id_,'-›  هاذا الامر خاص بالنائبين') 
return false
end
Text = [[
-›  اهلا بك√
...
if text == 'م4' then
if not Mod(msg) then
send(msg.chat_id_, msg.id_,'-›  هاذا الامر خاص بالمالكين') 
return false
end
Text = [[
-› اهلا بك√
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'ديلار')
