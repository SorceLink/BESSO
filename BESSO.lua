...
elseif database:sismember(bot_id..'Manager'..chat_id, user_id) then
var = database:get(bot_id.."Manager:Rd"..msg.chat_id_) or 'نائب المدير'  
elseif database:sismember(bot_id..'Mod:User'..chat_id, user_id) then
...
send(chat,msg.id_,"\n-› تم رفع الملف بنجاح وتفعيل المجموعات\n-› ورفع {المالكين الاساسيين ; والمالكين ; والنائبين; والادمنيه} بنجاح")   
end
...
Text = [[
📨: قناة السورس : [Dilar 𝒔𝒐𝒓𝒖𝒄𝒆](t.me/SourceDilar)
📨: مطور السورس : [Armando](t.me/IIIZIIII)
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
]]
send(msg.chat_id_, msg.id_,Text)
return false
...
database:del(bot_id..'Mod:User'..msg.chat_id_)
database:del(bot_id..'Special:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_,'\n-› تم تنزيل المالكين \n-› تم تنزيل النائبين \n-› تم تنزيل الادمنيه \n-› تم تنزيل المميزين  \n \n-› تم مسح جميع رتب\n-›  بواسطه ← [المالك الاساسي](t.me/SourceDilar') 
 end
